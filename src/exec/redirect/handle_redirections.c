...
const struct s_redirection_kvp	g_redir_tbl[] = {
	[REDIRECT_IN] = {.default_fd = 0, .handler = &redirect_in},
	[REDIRECT_IN_AND] = {.default_fd = 0, .handler = &redirect_in_and},
	[REDIRECT_OUT] = {.default_fd = 1, .handler = &redirect_out},
	[REDIRECT_OUT_APPEND] = {.default_fd = 1, .handler = &redirect_out_append},
